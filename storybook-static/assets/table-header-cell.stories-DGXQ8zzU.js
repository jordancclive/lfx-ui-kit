import{c as b}from"./table-header-cell-DmmpqlN-.js";const Q={title:"1. Components / 2. Molecules / 8. TableHeaderCell",tags:["autodocs"],render:e=>b(e),parameters:{docs:{description:{component:`
## TableHeaderCell
...
}`,...(z=($=c.parameters)==null?void 0:$.docs)==null?void 0:z.source}}};var M,_,B;d.parameters={...d.parameters,docs:{...(M=d.parameters)==null?void 0:M.docs,source:{originalSource:`{
  args: {
    children: 'Priority',
    showTooltip: true,
    sortDirection: 'desc'
...
}`,...(B=(_=d.parameters)==null?void 0:_.docs)==null?void 0:B.source}}};var G,K,j;p.parameters={...p.parameters,docs:{...(G=p.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: () => {
...
}`,...(j=(K=p.parameters)==null?void 0:K.docs)==null?void 0:j.source}}};var q,F,J;m.parameters={...m.parameters,docs:{...(q=m.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
...
}`,...(J=(F=m.parameters)==null?void 0:F.docs)==null?void 0:J.source}}};const U=["Default","RightAligned","WithTooltip","SortAsc","SortDesc","Disabled","DisabledWithSort","WithTooltipAndSort","AllVariants","InTableContext"];export{p as AllVariants,o as Default,l as Disabled,c as DisabledWithSort,m as InTableContext,t as RightAligned,a as SortAsc,i as SortDesc,s as WithTooltip,d as WithTooltipAndSort,U as __namedExportsOrder,Q as default};
