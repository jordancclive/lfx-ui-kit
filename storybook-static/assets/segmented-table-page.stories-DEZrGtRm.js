import{c as ie}from"./app-shell-CLFgneCT.js";import{c as le}from"./page-layout-DDkSngPm.js";import{c as ce}from"./app-header-DeHaskNY.js";import{c as G}from"./page-section-CrtrbsFd.js";import{c as S}from"./card-20Zp1JzI.js";import{c as pe,a as de,b as ue}from"./table-BqFkyqaa.js";import{c as i}from"./table-header-cell-BQFJGQJu.js";import{c as me}from"./table-row-Bd8rP5kn.js";import{c as l}from"./table-cell-FJBY3uM0.js";import{c as he}from"./search-input-CzMEtAKB.js";import{c as ge}from"./filter-dropdown-trigger-pmZu_dAG.js";import{b as ye,c as fe,a as p}from"./global-nav-l0iysLZC.js";import{c as be}from"./tag-Di5Xs3Pg.js";const oe=[{name:"Security Working Group",type:"Working Group",description:"Addresses security vulnerabilities and best practices for project security.",members:8,voting:!0,lastUpdated:"Mar 14, 2025"},{name:"Technical Advisory Group",type:"TAG",description:"Provides expert guidance on technical architecture and standards.",members:6,voting:!0,lastUpdated:"Mar 14, 2025"}],re=[{name:"Board of Directors",type:"Other",description:"Provides strategic oversight and governance for the organization.",members:8,voting:!0,lastUpdated:"Mar 14, 2025"},{name:"Cloud Native SIG",type:"Special Interest",description:"Focuses on cloud-native practices and containerization strategies.",members:24,voting:!0,lastUpdated:"Mar 14, 2025"},{name:"Technical Oversight Committee",type:"TOC",description:"Oversees technical operations and cross-project coordination.",members:11,voting:!0,lastUpdated:"Mar 14, 2025"},{name:"Technical Steering Committee",type:"TSC",description:"Guides technical direction and roadmap decisions.",members:12,voting:!0,lastUpdated:"Mar 14, 2025"}],we=[{name:"Security Working Group",type:"Working Group",description:"Addresses security vulnerabilities and best practices for project security. This group meets weekly to review CVEs, coordinate disclosure timelines, and establish security guidelines that all projects must follow. Members include security researchers, maintainers, and industry experts.",members:8,voting:!0,lastUpdated:"Mar 14, 2025"},{name:"Technical Advisory Group",type:"TAG",description:"Provides expert guidance on technical architecture and standards. The TAG reviews proposed changes to core infrastructure, evaluates new technology adoption, and publishes recommendations for the broader community. Regular office hours are held for project maintainers.",members:6,voting:!0,lastUpdated:"Mar 14, 2025"}],Ge=[{name:"Board of Directors",type:"Other",description:"Provides strategic oversight and governance for the organization. The board meets quarterly to review financial reports, approve major initiatives, and ensure alignment with the organization's mission. Members are elected by the community for two-year terms.",members:8,voting:!0,lastUpdated:"Mar 14, 2025"},{name:"Cloud Native SIG",type:"Special Interest",description:"Focuses on cloud-native practices and containerization strategies. This special interest group explores Kubernetes, service mesh technologies, and cloud provider integrations. Monthly demos showcase new tools and patterns adopted by member projects.",members:24,voting:!0,lastUpdated:"Mar 14, 2025"}],Se=[oe[0]],ve=[re[0]];function c(e){const t=document.createElement("span");return t.textContent=e,t}function Pe(){const e=document.createElement("span");return e.textContent="✓",e.style.color="var(--success-500)",e}function v(e,t=!1){const r=[i({children:"Name"}),i({children:"Type"}),i({children:"Description"}),i({children:"Members",align:"right"}),i({children:"Voting"}),i({children:"Last Updated"})],n=e.map(o=>{const s=[l({children:o.name,contentType:"primary"}),l({children:be({children:o.type}),contentType:"secondary"}),l({children:o.description,contentType:"secondary"}),l({children:String(o.members),contentType:"numeric",align:"right"}),l({children:o.voting?Pe():c("—")}),l({children:o.lastUpdated,contentType:"muted"})];return me({children:s,clickable:!0})});return pe({columns:6,dense:t,children:[de(r),ue(n)]})}function P(){const e=document.createElement("div");return e.style.display="flex",e.style.gap="var(--spacing-8)",e.style.alignItems="center",e.appendChild(he({placeholder:"Search Groups…",variant:"toolbar"})),e.appendChild(ge({label:"All Types"})),e}function T(e){const t=document.createElement("div");return t.textContent=e,t.style.fontFamily="var(--ui-text-section-title-font-family)",t.style.fontSize="var(--ui-text-section-title-font-size)",t.style.fontWeight="var(--ui-text-section-title-font-weight)",t.style.lineHeight="var(--ui-text-section-title-line-height)",t.style.color="var(--text-primary)",t.style.marginBottom="var(--spacing-12)",t}function F(e=1,t=42){const r=document.createElement("div");r.style.display="flex",r.style.justifyContent="space-between",r.style.alignItems="center";const n=document.createElement("span");n.textContent=`Rows ${(e-1)*10+1}–${Math.min(e*10,t)} of ${t}`,n.style.fontFamily="var(--ui-text-body-secondary-font-family)",n.style.fontSize="var(--ui-text-body-secondary-font-size)",n.style.color="var(--text-secondary)";const o=document.createElement("div");o.style.display="flex",o.style.gap="var(--spacing-8)";const s=document.createElement("button");s.textContent="Previous",s.disabled=e===1,s.style.fontFamily="var(--ui-text-control-font-family)",s.style.fontSize="var(--ui-text-control-font-size)";const a=document.createElement("button");return a.textContent="Next",a.disabled=e*10>=t,a.style.fontFamily="var(--ui-text-control-font-family)",a.style.fontSize="var(--ui-text-control-font-size)",o.appendChild(s),o.appendChild(a),r.appendChild(n),r.appendChild(o),r}function Te(e="groups"){return ye({activeItemId:e,children:[fe([p({id:"dashboard",children:c("Dashboard")}),p({id:"projects",children:c("Projects")}),p({id:"groups",children:c("Groups")}),p({id:"members",children:c("Members")}),p({id:"settings",children:c("Settings")})])]})}function Fe(e){const t=document.createElement("div");return t.style.maxWidth="1280px",t.style.margin="0 auto",t.appendChild(e),t}function Ce(e={}){const{dense:t=!1,myGroups:r=oe,otherGroups:n=re,myGroupsShowFilters:o=!0,myGroupsShowPagination:s=!1,otherGroupsShowFilters:a=!1,otherGroupsShowPagination:ne=!1}=e,w=[ce({title:"Groups",description:"A group is a team of people like committees, boards, or working groups organized to collaborate across your project.",dense:t})],f=[];o&&f.push(P()),f.push(v(r,t)),s&&f.push(F(1,r.length)),w.push(G({dense:!0,children:[T("My Groups"),S({dense:t,children:f})]}));const b=[];a&&b.push(P()),b.push(v(n,t)),ne&&b.push(F(1,n.length)),w.push(G({dense:!0,children:[T("Other Groups"),S({dense:t,children:b})]}));const se=le({dense:t,children:w}),ae=ie({nav:Te(),content:se});return Fe(ae)}const Re={title:"2. Page Patterns / Segmented Table Page",tags:["autodocs"],parameters:{layout:"fullscreen",docs:{description:{component:`
...
- Layout resilience without controls`,...(R=(I=m.parameters)==null?void 0:I.docs)==null?void 0:R.description}}};var W,H,L,q,V;h.parameters={...h.parameters,docs:{...(W=h.parameters)==null?void 0:W.docs,source:{originalSource:`{
  args: {
    dense: false,
    myGroupsShowFilters: true,
...
}`,...(L=(H=h.parameters)==null?void 0:H.docs)==null?void 0:L.source},description:{story:`Segmented Table Page with pagination.
