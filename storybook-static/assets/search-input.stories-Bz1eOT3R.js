...
}`,...(h=(p=r.parameters)==null?void 0:p.docs)==null?void 0:h.source},description:{story:"Focus state - click into the input to see focus styling.\n\nBorder color changes to `color.interactive.primary.background`.",...(m=(u=r.parameters)==null?void 0:u.docs)==null?void 0:m.description}}};var f,g,b,v,y;o.parameters={...o.parameters,docs:{...(f=o.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    placeholder: 'Search...',
    disabled: true,
    showIcon: false
  }
}`,...(b=(g=o.parameters)==null?void 0:g.docs)==null?void 0:b.source},description:{story:`Disabled state.

Uses:
- Border: \`neutral.neutral-300\`
- Text/placeholder/icon: \`color.text.disabled\`
- No focus styles`,...(y=(v=o.parameters)==null?void 0:v.docs)==null?void 0:y.description}}};var w,S,x,I,T;a.parameters={...a.parameters,docs:{...(w=a.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    placeholder: 'Search...',
    disabled: false,
    showIcon: true
  }
}`,...(x=(S=a.parameters)==null?void 0:S.docs)==null?void 0:x.source},description:{story:`Search input with icon.

Icon inherits text color and size derives from font-size.`,...(T=(I=a.parameters)==null?void 0:I.docs)==null?void 0:T.description}}};var k,W,B,D,F;t.parameters={...t.parameters,docs:{...(k=t.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
...
}`,...(B=(W=t.parameters)==null?void 0:W.docs)==null?void 0:B.source},description:{story:`Toolbar variant for use in filter bars and table headers.
...
Use in: table filter bars, list headers, Groups page, Votes, Surveys.`,...(F=(D=t.parameters)==null?void 0:D.docs)==null?void 0:F.description}}};const C=["Default","Focus","Disabled","WithIcon","Toolbar"];export{e as Default,o as Disabled,r as Focus,t as Toolbar,a as WithIcon,C as __namedExportsOrder,U as default};
