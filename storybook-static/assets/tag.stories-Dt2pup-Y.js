import{c as r}from"./tag-Di5Xs3Pg.js";import{c as a}from"./table-cell-FJBY3uM0.js";import{c as be,a as xe,b as we}from"./table-BqFkyqaa.js";import{c as s}from"./table-header-cell-BQFJGQJu.js";import{c as C}from"./table-row-Bd8rP5kn.js";import{c as Se}from"./card-20Zp1JzI.js";const We={title:"1. Components / 1. Level 1 / Tag",tags:["autodocs"],parameters:{docs:{description:{component:`
...
Tag uses intrinsic width and does not stretch.`,...(S=(w=o.parameters)==null?void 0:w.docs)==null?void 0:S.description}}};var I,D,O,N,E;l.parameters={...l.parameters,docs:{...(I=l.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    children: 'Information',
    variant: 'info'
  }
}`,...(O=(D=l.parameters)==null?void 0:D.docs)==null?void 0:O.source},description:{story:`Info variant — Informational categorical data.
Visual only, no interaction or status semantics.`,...(E=(N=l.parameters)==null?void 0:N.docs)==null?void 0:E.description}}};var G,W,k,R,V;d.parameters={...d.parameters,docs:{...(G=d.parameters)==null?void 0:G.docs,source:{originalSource:`{
  args: {
    children: 'Completed',
    variant: 'success'
  }
}`,...(k=(W=d.parameters)==null?void 0:W.docs)==null?void 0:k.source},description:{story:`Success variant — Positive categorical data.
Visual only, no interaction or status semantics.`,...(V=(R=d.parameters)==null?void 0:R.docs)==null?void 0:V.description}}};var P,H,A,F,B;p.parameters={...p.parameters,docs:{...(P=p.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    children: 'Review Required',
    variant: 'warning'
  }
}`,...(A=(H=p.parameters)==null?void 0:H.docs)==null?void 0:A.source},description:{story:`Warning variant — Cautionary categorical data.
