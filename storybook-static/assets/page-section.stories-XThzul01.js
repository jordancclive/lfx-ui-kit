import{c as t}from"./page-section-CrtrbsFd.js";import{c as ce}from"./page-layout-DDkSngPm.js";import{c as oe}from"./app-header-DeHaskNY.js";import{c as de}from"./list-group-oA2mGORs.js";import{c as S}from"./list-item-CxESGsFY.js";import{c as le,a as se,b as pe}from"./table-BqFkyqaa.js";import{c as y}from"./table-header-cell-BQFJGQJu.js";import{c as C}from"./table-row-Bd8rP5kn.js";import{c as o}from"./table-cell-FJBY3uM0.js";const xe={title:"1. Components / 3. Level 3 / PageSection",tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
## PageSection
...
}`,...(L=(w=l.parameters)==null?void 0:w.docs)==null?void 0:L.source},description:{story:"Dense spacing mode (reduced vertical padding)",...(H=(E=l.parameters)==null?void 0:E.docs)==null?void 0:H.description}}};var k,I,A,O,M;s.parameters={...s.parameters,docs:{...(k=s.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
    children: createPlaceholderContent('Section with Divider'),
    withDivider: true
  }
}`,...(A=(I=s.parameters)==null?void 0:I.docs)==null?void 0:A.source},description:{story:"Section with bottom divider",...(M=(O=s.parameters)==null?void 0:O.docs)==null?void 0:M.description}}};var z,B,N,R,W;p.parameters={...p.parameters,docs:{...(z=p.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: () => {
...
}`,...(N=(B=p.parameters)==null?void 0:B.docs)==null?void 0:N.source},description:{story:"Multiple PageSections stacked together",...(W=(R=p.parameters)==null?void 0:R.docs)==null?void 0:W.description}}};var V,j,G,F,U;h.parameters={...h.parameters,docs:{...(V=h.parameters)==null?void 0:V.docs,source:{originalSource:`{
  render: () => {
    const container = document.createElement('div');
...
}`,...(G=(j=h.parameters)==null?void 0:j.docs)==null?void 0:G.source},description:{story:"PageSection with real content components",...(U=(F=h.parameters)==null?void 0:F.docs)==null?void 0:U.description}}};var _,Y,$,q,J;m.parameters={...m.parameters,docs:{...(_=m.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: () => {
