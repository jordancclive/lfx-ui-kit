import{c as p}from"./table-row-DLTwFnyp.js";const K=()=>[{text:"John Doe",width:"150px"},{text:"john@example.com",width:"200px"},{text:"Active",width:"100px"}].map(({text:m,width:d})=>{const t=document.createElement("div");return t.textContent=m,t.style.width=d,t.style.flexShrink="0",t}),re={title:"1. Components / 2. Molecules / 10. TableRow",tags:["autodocs"],render:e=>p({...e,children:K()}),argTypes:{selected:{control:"boolean",description:"Selected state"},disabled:{control:"boolean",description:"Disabled state - overrides all other states"},clickable:{control:"boolean",description:"Whether row is clickable (shows pointer cursor, enables hover)"}},parameters:{docs:{description:{component:`
...
Note: Selected overrides hover.`,...(T=(R=o.parameters)==null?void 0:R.docs)==null?void 0:T.description}}};var A,E,H,M,N;a.parameters={...a.parameters,docs:{...(A=a.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    selected: false,
    disabled: true,
    clickable: false
...
Note: Disabled overrides all other states (including selected).`,...(N=(M=a.parameters)==null?void 0:M.docs)==null?void 0:N.description}}};var P,U,I,J,W;n.parameters={...n.parameters,docs:{...(P=n.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    selected: false,
    disabled: false,
    clickable: true
...
}`,...(I=(U=n.parameters)==null?void 0:U.docs)==null?void 0:I.source},description:{story:`Clickable row - shows pointer cursor and enables hover.
Click the row and check the console.`,...(W=(J=n.parameters)==null?void 0:J.docs)==null?void 0:W.description}}};var L,O,_,$,j;l.parameters={...l.parameters,docs:{...(L=l.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
    selected: false,
    disabled: false,
    clickable: false
