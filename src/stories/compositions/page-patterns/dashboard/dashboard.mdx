...
> **⚠️ CANONICAL DOCUMENTATION WARNING**
>
...
>
> **Storybook Hierarchy:**
> - `2. Page Patterns / Dashboard` ← You are here (canonical pattern)
> - `3. Page Examples / <Role> Dashboard` ← Concrete role implementations
...
|-----|------------------|-------------------|
| Board Member | Metric Carousel, Action Summary, Meeting Summary, Table Preview | ✅ Validated |
| Maintainer | Metric Carousel, Action Summary, Meeting Summary, Table Preview | ✅ Validated |
| Contributor | Metric Carousel, Action Summary, Table Preview | 🚧 Planned |
| Executive Director | Metric Carousel, Action Summary, Meeting Summary, Strategic Alerts | 🚧 Planned |
...
- ✅ **Board Member Dashboard** — Fully validated (see `docs/steward/validations/board-member-dashboard.v1.md`)
- ✅ **Maintainer Dashboard** — Fully validated (pattern validation complete)
- 🚧 **Contributor Dashboard** — Planned (optional third role validation)
- 🚧 **Executive Director Dashboard** — Planned
