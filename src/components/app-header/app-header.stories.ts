...
const meta: Meta<AppHeaderProps> = {
  title: '1. Components / Level 3 / AppHeader',
  tags: ['autodocs'],
  parameters: {
    layout: 'fullscreen',
    docs: {
...
/**
 * Header with metadata slot (e.g., status pill) before title
 */
...
/**
 * Full example: meta + title + description + actions
 */
...
/**
 * Header with bottom divider border
 */
...
/**
 * Complex composition: meta + tabs + buttons
 */
